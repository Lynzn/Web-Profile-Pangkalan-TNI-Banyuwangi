...
@section('heading', 'Informasi Pendaftaran di Pangkalan TNI AL Banyuwangi')
@section('page')
...
@section('content')
    ...
    <section class="pendaftaran__lanal">
        <div class="container">
            <div class="row">
                @foreach ($pendaftaran as $item)
                    <div class="col-md-6 col-lg-4 py-3">
                        <div class="blog-entry">
                            <div class="course-1">
                                <div class="thumbnail">
                                    <a href="{{ route('pendaftaran.detail', $item->slug_pendaftaran) }}">
                                        <img src="{{ URL::asset($item->gambar)}}" alt="{{ $item->judul_pendaftaran }}" class="img-fluid">
                                    </a>
                                ...
                                <div class="text bg-white pendaftaran p-4">
                                    <h3 class="heading"><a href="{{ route('pendaftaran.detail', $item->slug_pendaftaran) }}">{{ $item->judul_pendaftaran }}</a></h3>
                                    <p class="mb-4"><?= Str::limit(strip_tags($item->isi), 150, $end = '...') ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="{{ route('pendaftaran.detail', $item->slug_pendaftaran) }}" class="btn btn-primary">Baca Selengkapnya</a>
